...
#
# Assemble Santorini Island seasons animation using Sentinelflow
...
sentinelflow.sh ${*:---offline} \
    --intersect 36.4,25.4 --cloudcover 10 --tiles 35SLA \
    --daterange 20200101..20201231 --maxrows 100 \
    --extent 336000,4015000,376000,4045000 --name europe/santorini
...
20200606_091025_214_S2A_RGB.jpg
...
20200626_091024_378_S2A_RGB.jpg 20200701_091021_221_S2B_RGB.jpg
...
20200805_091024_866_S2A_RGB.jpg
...
20201004_091024_695_S2A_RGB.jpg 20201009_091022_572_S2B_RGB.jpg
20201024_091024_220_S2A_RGB.jpg
20201113_091022_587_S2A_RGB.jpg 20201128_091018_666_S2B_RGB.jpg
"

# add text labels using imagemagick
srcdir="composite/europe/santorini"
prefix="animation/santorini"
...
do
    ...
    if [ -f $ifile ] && [ ! -f $ofile ]
    then
        convert $ifile -crop 3360x1890+420+555 -resize 1920x1080 +repage \
                ...
                -pointsize 24 -gravity southeast -annotate +60+70 "3.5 km" $ofile
    fi
done
