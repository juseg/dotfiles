...
## Qaanaaq 60x60 km (intersect on Bowdoin Glacier, offline)
#sentinelflow.sh ${*:-} --offline \
#    --intersect 77.7,-68.5 --tiles 19XDG,19XEG \
#    --extent 465000,8595000,525000,8655000 --name greenland/qaanaaq-60x60

## Qaanaaq 60x40 km (offline)
#sentinelflow.sh ${*:-} --offline \
#    --intersect 77.7,-68.6 --tiles 19XDG,19XEG \
#    --extent 465000,8595000,525000,8635000 --name greenland/qaanaaq-60x40
