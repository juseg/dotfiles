...
alias site.remote='for repo in ~/git/site/*; do echo == $repo; git -C $repo remote --verbose; done'
alias site.status='for repo in ~/git/site/*; do echo == $repo; git -C $repo status --short; done'
alias site.pull='for repo in ~/git/site/*; do echo == $repo; git -C $repo pull --rebase; done'
alias site.push='for repo in ~/git/site/*; do echo == $repo; git -C $repo push --tags; done'
