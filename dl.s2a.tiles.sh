...
# Run parent script dl.s2a.sh to prepare tile previews
# ====================================================

## Bash command line to list downloaded tiles
# ls granules/ | cut -d '_' -f 10 | sort | uniq -c

args="--resolution 50 --nullvalues 100 $*"
basedir=$SCRATCH2/geodata/satellite/sentinel-2a
prevdir=$basedir/composite/previews
tiledir=$basedir/composite/tiles
